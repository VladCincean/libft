...
size_t	ft_strlcat(char *dest, const char *src, size_t n); //double-check this
...
int		ft_isalpha(int c); // check this on Mac
...
char	**ft_strsplit(char const *s, char c); // segfault :(
char	*ft_itoa(int n);
...
int		ft_islower(int c); // check this on Mac
